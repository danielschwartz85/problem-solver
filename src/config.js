const Config = {
  ...
  mandalasScreen: {
    ...
    colors: [
      ...
      {name: 'אפור', code: '#6c6d70', verbs: ['י.ס.ד', 'ב.ד.ד', 'ד.ב.ר', 'ע.ג.ם']},
      {name: 'חום', code: '#682f00', verbs: ['א.ד.מ', 'י.צ.ב']},
      {name: "ב'ז", code: '#e3bb6f', verbs: ['ז.ר.מ', 'ח.ב.ר', 'ש.נ.ה']},
      {name: 'כתום', code: '#f36e21', verbs: ['פ.א.ר', 'פ.ע.ר', 'ק.ש.ר']},
      {
        name: 'ורוד',
        code: '#f499c2',
        verbs: [
      ...
      {name: 'ירוק', code: '#40ae49', verbs: ['ג.ד.ל', 'פ.ת.ח', 'צ.מ.ח']},
      {
        name: 'סגול',
        code: '#65288a',
        verbs: ['‫ח‪.‬כ‪.‬מ‬', '‫י‪.‬ד‪.‬ע‬', '‫ס‪.‬ג‪.‬ל‬', '‫ר‪.‬פ‪.‬א‬', '‫ר‪.‬פ‪.‬ה‬'],
        isDark: true,
      },
      {
        name: 'ירוק כהה',
      ...
      {name: 'כחול', code: '#253f8e', verbs: ['ב.נ.ה', 'י.ב.נ'], isDark: true},
      {
        name: 'תכלת',
        code: '#6bcff6',
        verbs: [
